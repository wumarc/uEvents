      ...
      >
        ...
        <View style={styles.footer_buttons}>
          <Button
            ...
            title={"Back"}
            onPress={() => (step == 1 ? navigation.pop() : step == 9 && freeEventProps ? setStep(step - 2) : setStep(step - 1))}
  ...
  return (
    <View>
      <Text style={{ ...fonts.title1, ...spacing.verticalMargin2 }}>
        Pick <Text style={{ color: "red", textDecorationLine: "underline" }}>one</Text> emoji to represent your event
      </Text>
      ...
      <View style={{ marginVertical: "5%", paddingHorizontal: "25%" }}>
        ...
        <Input
          ...
          onChange={(e) => {
            set({ ...event, emoji: e.nativeEvent.text });
          }}
          maxLength={8}
        />
        {/* <Input
        ...
        {event.onCampus ? (
          ...
          <View>
            <Input
              ...
              maxLength={60}
              onChange={(e) => {
                set({ ...event, address: e.nativeEvent.text, onCampus: false });
              }}
            />
            <Input
  ...
  return (
    <View>
      <View>
        ...
        <Text style={fonts.regular}>Anything you want to share that is not in the title.</Text>
      </View>

      <View style={{ marginVertical: "5%" }}>
        <Text>
          {charactersAvailable} <Text style={{ color: colours.grey }}>characters available</Text>
        </Text>
        <Input
          selectionColor={colours.purple}
        ...
        <View style={{ flexDirection: "row", ...spacing.verticalMargin1 }}>
          <View style={{ width: "48%" }}>
            <Input
              ...
              onChange={(e) => {
                set({ ...event, priceMin: parseInt(e.nativeEvent.text) });
              }}
            />
          </View>
          ...
          <View style={{ width: "48%" }}>
            <Input
              ...
              onChange={(e) => {
                set({ ...event, priceMax: parseInt(e.nativeEvent.text) });
              }}
            />
          </View>
        </View>
    ...
    <View>
      ...
      {(event.signUpLink || event.signUpLink != "" || showField) && (
        <View style={{ marginVertical: "5%" }}>
          <Input
            ...
            containerStyle={{ paddingHorizontal: 0 }}
            onChange={(e) => {
              set({ ...event, signUpLink: e.nativeEvent.text });
            }}
            maxLength={300}
          />
        </View>
      ...
      {props.isAdmin && (
        <Input
          ...
          containerStyle={{ paddingHorizontal: 0 }}
          onChange={(e) => {
            set({ ...event, originalLink: e.nativeEvent.text });
          }}
          maxLength={300}
        />
      )}
...
export const Step8: FC<{ eventID: string }> = (props) => {
  ...
  categories = getOrderedCategories(events!, event.id);
  ...
  const updateEvent = (indexes: number[]) => {
    ...
    for (const index of indexes) {
      newCategories.push(fixedCategories[index]!);
    }
  ...
  return (
    <View>
      <View>
        <Text style={{ ...fonts.title1, ...spacing.verticalMargin2 }}>Select up to 5 tags for your event</Text>
        <Text>Tags are used as categories and search keywords.</Text>
      </View>
      <MultiSelect
        search
      ...
      <Input
        ...
        containerStyle={{ paddingHorizontal: 0 }}
        onChangeText={(text) => {
          setNewCategory(text.toLowerCase());
        }}
        value={newCategory}
        maxLength={30}
        defaultValue={event.roomNumber}
      ...
      />
      <Text>Avoid tags that contain information already specified such as "On campus" or "Free". Separate words with spaces.</Text>
      <View></View>
    </View>
  );
};
    ...
    <View style={{}}>
      ...
      <View style={spacing.verticalMargin1}>
        ...
        <Input
          label={
            <Text>
              Emoji <Text style={{ color: "red" }}>*</Text>
            </Text>
          }
          selectionColor={colours.purple}
          inputContainerStyle={{
        ...
        <View style={{ flexDirection: "row" }}>
          <Input
            ...
            onChange={(e) => {
              set({ ...event, priceMin: Number(e.nativeEvent.text) });
            }}
            selectionColor={colours.purple}
            inputContainerStyle={{
              borderColor: colours.grey,
          ...
          <Input
            ...
            onChange={(e) => {
              set({ ...event, priceMax: Number(e.nativeEvent.text) });
            }}
            selectionColor={colours.purple}
            inputContainerStyle={{
              borderColor: colours.grey,
        ...
        {/* Tags */}
        <View>
          <Text style={{ ...fonts.title3, fontWeight: "bold", color: "grey" }}>Tags</Text>
          <MultiSelect
            search
            searchPlaceholder="Search tags"
            placeholderStyle={{ fontSize: 17, padding: 7 }}
  ...
  return (
    <View>
      <View>
        ...
        <Text style={fonts.regular}>Events approval can take up to 2 hours.</Text>
      </View>
    </View>
  );
};
