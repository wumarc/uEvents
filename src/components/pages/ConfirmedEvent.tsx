    ...
    return (
        <View>
            <Text style={styles.baseText}>
                <Text style={styles.confirmedFontSize}> CONFIRMED (New Font) {`\n`} </Text> 
            ...
            <Text style={styles.regularFontSize}> Your have confirmed your ticket for "" event, on the day of "June 26th"! </Text>  
