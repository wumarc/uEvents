  ...
  return (
    <View>
      <Input
        ...
        disabled
        value={`${dateMonth} ${dateDay} ${initialDate.getHours() % 12}:${
          initialDate.getMinutes() < 10 ? "0" + initialDate.getMinutes() : initialDate.getMinutes()
        } ${initialDate.getHours() > 11 ? "PM" : "AM"}`}
        onPressIn={() => setShow(true)}
      />
      <Modal visible={show} onRequestClose={() => setShow(false)} presentationStyle="overFullScreen" transparent={true}>
        <View
          style={{
